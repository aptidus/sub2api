...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminUserHandler := admin.NewUserHandler(adminService, concurrencyService, apiKeyService, serviceUserPlatformQuotaRepository, billingCache)
	...
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, emailService, accountUsageService, redisClient, configConfig, proxyRepository)
