...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminUserHandler := admin.NewUserHandler(adminService, concurrencyService, apiKeyService)
	...
	opsAlertEvaluatorService := service.ProvideOpsAlertEvaluatorService(opsService, opsRepository, emailService, accountUsageService, redisClient, configConfig)
