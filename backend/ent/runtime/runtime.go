...
func init() {
	...
	// apikeyDescInternalUsage is the schema descriptor for internal_usage field.
	apikeyDescInternalUsage := apikeyFields[5].Descriptor()
	// apikey.DefaultInternalUsage holds the default value on creation for the internal_usage field.
	apikey.DefaultInternalUsage = apikeyDescInternalUsage.Default.(bool)
	...
	subscriptionplanDescStripePriceID := subscriptionplanFields[9].Descriptor()
	// subscriptionplan.DefaultStripePriceID holds the default value on creation for the stripe_price_id field.
	subscriptionplan.DefaultStripePriceID = subscriptionplanDescStripePriceID.Default.(string)
	...
	// userDescInternalUsage is the schema descriptor for internal_usage field.
	userDescInternalUsage := userFields[8].Descriptor()
	// user.DefaultInternalUsage holds the default value on creation for the internal_usage field.
	user.DefaultInternalUsage = userDescInternalUsage.Default.(bool)
