> **Source:** This repository is a deployment-time copy of [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) (MIT-licensed). It is deployed unmodified; configuration is supplied at runtime via environment variables and the admin UI.
