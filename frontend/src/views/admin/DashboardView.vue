              ...
              <div>
                ...
                <p class="text-xs">
                  <span
                    ...
                    >${{ formatCost(stats.today_customer_actual_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-orange-500 dark:text-orange-400"
                    :title="t('admin.dashboard.accountCost')"
                    >${{ formatCost(stats.today_customer_account_cost) }}</span
                  >
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <p class="text-xs">
                  <span
                    class="text-green-600 dark:text-green-400"
                    :title="t('admin.dashboard.actual')"
                    >${{ formatCost(stats.total_customer_actual_cost) }}</span
                  >
                  <span class="text-gray-400 dark:text-gray-500"> / </span>
                  <span
                    class="text-orange-500 dark:text-orange-400"
                    :title="t('admin.dashboard.accountCost')"
                    >${{ formatCost(stats.total_customer_account_cost) }}</span
                  >
                </p>
              </div>
            </div>
