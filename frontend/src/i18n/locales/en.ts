export default {
  ...
  dashboard: {
    ...
    createApiKey: 'View API Key',
    generateNewKey: 'Copy or rotate your provisioned API key',
    viewUsage: 'View Usage',
    checkDetailedLogs: 'Check detailed usage logs',
    viewApiDocs: 'View API Docs',
    useKeyWithDocs: 'Use your key with Messages, Chat Completions, or Responses',
  ...
  apiDocs: {
    ...
    title: 'API Docs',
    description: 'Customer-safe instructions for using your provisioned key and calling Sub2API. Admin secrets, upstream account details, and internal cost data are intentionally not included.',
    createKey: 'Open API Keys',
    step1Title: '1. Copy your key',
    step1Body: 'Users receive a provisioned sk-... API key. Admin keys and upstream account details must stay server-side.',
    step2Title: '2. Pick an endpoint',
    step2Body: 'Use Messages, Chat Completions, or Responses depending on the client.',
    step3Title: '3. Track usage',
    step3Body: 'Usage is logged automatically so billing and limits can be calculated.'
  },
  ...
  keys: {
    title: 'API Keys',
    description: 'Copy or rotate the API key provisioned for your account',
    ...
    createKey: 'API Key',
    provisionedTitle: 'Your key is provisioned for this account',
    provisionedDescription: 'Normal users do not create or configure keys. Use this page to copy your assigned key, view usage, or rotate the secret if it is exposed.',
    rotateKey: 'Rotate Key',
    rotateConfirmTitle: 'Rotate API key?',
    rotateConfirmMessage: "Rotating '{name}' immediately disables the old key value and creates a new one. Your usage history, limits, and billing record stay the same.",
    keyRotatedSuccess: 'API key rotated and copied to clipboard',
    ...
    createFirstKey: 'Your account needs a provisioned API key before you can call the API.',
    noProvisionedKey: 'No API key is provisioned for this account yet. Contact the admin or support team to assign one.',
  ...
  admin: {
    ...
    dashboard: {
      ...
      requests: 'Requests',
      tokens: 'Tokens',
      actual: 'Stripe-paid charged',
      standard: 'Standard',
      accountCost: 'Stripe-paid upstream cost',
      todayUsageProfit: 'Today Usage Profit',
      totalUsageProfit: 'Total Usage Profit',
      chargedMinusCost: '{charged} Stripe-funded usage - {cost} upstream cost',
      margin: 'Margin',
      internalUsageCost: 'Internal/Test Usage Cost',
      todayInternalUsageCost: 'Today internal cost',
      apiDocsEyebrow: 'Launch docs',
      apiDocsTitle: 'Latest customer API documentation',
      apiDocsDescription: 'Admin-only shortcut to the detailed user API guide: auth, model listing, Messages, Chat Completions, Responses, token counting, usage, and security rules.',
    ...
    users: {
      ...
      apiKeyInternalUsageHint: 'Usage from this key is still tracked as internal cost, but does not count as customer profit.',
      form: {
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
        rpmLimitHint: 'Max requests per minute for this user; 0 = unlimited. Acts as a fallback only when the group has no rpm_limit set.',
        internalUsage: 'Track as internal usage',
        internalUsageHint: 'Usage is still recorded and costed, but excluded from customer profit. Use this for admin, local, testing, and project keys.'
      },
      columns: {
        user: 'User',
        id: 'ID',
      ...
      createApiKeyForUser: 'Create key for this user',
      createApiKeyForUserHint: 'The new key will belong to this user, not the admin account.',
      createApiKey: 'Create key',
      apiKeyNamePlaceholder: 'Key name',
      copyNewKeyNow: 'Copy this key now. It will only be shown in full once.',
      apiKeyCreated: 'API key created for user',
      ...
      markInternalUsage: 'Mark internal',
      markCustomerUsage: 'Mark customer',
      internalUsageChanged: 'Internal tracking updated',
      internalUsageChangeFailed: 'Failed to update internal tracking',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Sub2API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Sub2API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Copy your provisioned API key</li><li>📋 Follow the API docs</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
